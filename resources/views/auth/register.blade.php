            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group">
                            <label for="" class="col-md-4 control-label">Age</label>

                            <div class="col-md-6">
                                <input id="" type="text" class="form-control" name="age" required>
                            </div>
                        </div>
                         <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="" type="text" class="form-control" name="gender" required>
                            </div>
                        </div>
                         <div class="form-group">
